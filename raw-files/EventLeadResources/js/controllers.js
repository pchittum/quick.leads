...
//app.controller('HomeCtrl', ['$scope', 'AngularForce', '$location', '$route', 'Event', 'ActiveEvent',
...
function ContactListCtrl($scope, AngularForce, $location, Lead, NewLeadService, ActiveEvent) {
    $scope.authenticated = AngularForce.authenticated();
    if (!$scope.authenticated) {
        return $location.path('/login');
    }
...
function ContactCreateCtrl($scope, AngularForce, $location, Lead, NewLeadService, CampaignMember, ActiveEvent) {
